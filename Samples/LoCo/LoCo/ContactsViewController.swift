...
class ContactsViewController: UITableViewController {
    ...
    var detailViewController: ContactViewController? = nil
    var objects = [Any]()
    ...
    override func viewDidLoad() {
        ...
        if let split = splitViewController {
            ...
            detailViewController = (controllers[controllers.count-1] as! UINavigationController).topViewController as? ContactViewController
        }
    }
